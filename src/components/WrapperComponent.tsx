...
function WrapperComponent({ItemModal, setModal, modalName}) {
    ...
    return (
        <Modal propagateSwipe style={{padding: 0, margin: 0, flex:1}} animationIn={'fadeInUp'} animationInTiming={600} animationOutTiming={500} animationOut={'slideOutDown'} coverScreen={false} backdropOpacity={0} isVisible={!!ItemModal} onBackdropPress={() => setModal(null)}>
            <SafeAreaView style={{backgroundColor: '#fff',borderRadius:0, paddingTop:20, width:"100%", height: '100%'}}>
