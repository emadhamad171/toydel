...
export const ItemComponent = ({
  ...
  const removeItemFromFavoriteList = () => {
    const updatedList = user.favoriteList.filter((listItem) => {
      if (listItem !== item.id) return listItem;
    });
    updateItemInDocFromCollection({
      updatedItem: { favoriteList: updatedList },
      collectionPath: "users",
      docName: auth.currentUser.uid,
    });
